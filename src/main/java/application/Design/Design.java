...
import application.Regex.Regex;
...
public class Design {
    ...
    private Regex regexProcessor;
    private data dataManager;
    private ListView<String> listView;

    public Design() {
        regexProcessor = new Regex();
    ...
    public VBox createDataSection() {
        ...
        // Add heading for the application.data management section
        Label headingLabel = new Label("Data");
        headingLabel.setStyle("-fx-font-size: 16px; -fx-font-weight: bold;"); // Optional: Style the heading
        ...
        HBox buttonBox = new HBox(10); // HBox with 10 pixels spacing
        buttonBox.getStyleClass().add("button-container"); // Add container style class
